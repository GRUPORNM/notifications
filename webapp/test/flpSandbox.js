		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#notificationsoverview-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"notificationsoverview-display": {
								"semanticObject": "notificationsoverview",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=notificationsoverview",
									"url": sap.ui.require.toUrl("notificationsoverview")
								}
							}
						}
					}
